...
RSpec.describe '/circles', type: :request do
  ...
  # CirclesController, or in your router and rack
  ...
  describe 'GET /index' do
    it 'renders a successful response' do
      ...
      get circles_url, headers: valid_headers, as: :json
  ...
  describe 'POST /create' do
    context 'with valid parameters' do
      it 'creates a new Circle' do
        expect {
          post circles_url,
               params: { circle: valid_attributes }, headers: valid_headers, as: :json
    ...
    context 'with invalid parameters' do
      it 'does not create a new Circle' do
        expect {
          post circles_url,
               params: { circle: invalid_attributes }, as: :json
        }.to change(Circle, :count).by(0)
      end

      it 'renders a JSON response with errors for the new circle' do
        post circles_url,
             params: { circle: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe 'PATCH /update' do
    context 'with valid parameters' do
      ...
      it 'updates the requested circle' do
        circle = Circle.create! valid_attributes
        patch circle_url(circle),
              params: { circle: new_attributes }, headers: valid_headers, as: :json
        circle.reload
  ...
  describe 'DELETE /destroy' do
    it 'destroys the requested circle' do
      circle = Circle.create! valid_attributes
      expect {
        delete circle_url(circle), headers: valid_headers, as: :json
      }.to change(Circle, :count).by(-1)
    end
  end
end
